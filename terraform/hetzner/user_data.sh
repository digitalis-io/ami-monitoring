...
export CLOUD_ENVIRONMENT=hetzner
export ANSIBLE_ROLE=role_${role}
export ANSIBLE_USER=ansible
export ANSIBLE_INVENTORY="/opt/ansible-monitoring/inventory/hetzner.yaml"
...
ANSIBLE_INVENTORY="/opt/ansible-monitoring/inventory/hetzner.yaml"
S3_ENDPOINT=${s3_endpoint}
END
